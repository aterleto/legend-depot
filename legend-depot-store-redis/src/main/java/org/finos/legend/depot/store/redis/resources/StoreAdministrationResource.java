...
package org.finos.legend.depot.store.redis.resources;
...
import org.finos.legend.depot.store.redis.admin.RedisAdminStore;
...
public class StoreAdministrationResource extends BaseAuthorisedResource
{
    ...
    private final RedisAdminStore manageStoreService;
    private final StorageMetrics storageMetrics;

    @Inject
    protected StoreAdministrationResource(RedisAdminStore manageStoreService,
    ...
    @ApiOperation("remove")
    public boolean remove(@PathParam("collection") String collection)
    {
        return handle("delete index", () ->
        {
            validateUser();
            manageStoreService.deleteIndex(collection);
            return true;
        });
    }
    ...
    private List<String> getAllIndexes()
    {
