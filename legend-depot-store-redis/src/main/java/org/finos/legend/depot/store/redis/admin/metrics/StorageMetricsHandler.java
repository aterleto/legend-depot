...
//TODO we can create a base class for this to reduce redundancies
public class StorageMetricsHandler implements StorageMetrics
{
    ...
    private final RedisAdminStore adminStore;
    private final PrometheusMetricsHandler metricsHandler;

    @Inject
    public StorageMetricsHandler(RedisAdminStore adminStore, PrometheusMetricsHandler metricsHandler)
    {
    ...
    public Object reportMetrics()
    {
        ...
        //stats.dbStats = getDbStats(); //TODO

         if (stats.dbStats != null)
         {
             logMetrics(stats.dbStats);
         }
         //stats.collectionStats = getCollectionsStats(); //TODO
